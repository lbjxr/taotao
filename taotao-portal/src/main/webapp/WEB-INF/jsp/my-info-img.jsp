						...
						<div class="mc update-face-cont">
							<div class="update-lcol">
								...
								<div class="img-b-cont img-cont ">
									...
									<div class="img-b">
										<img id="bigImage" name="bigImage" alt="" width="150" height="150" src="/image/defaultImgs/1.jpg">
									</div>
								</div>
								<div class="smt"><h3>推荐头像</h3></div>
								<div class="smc face-list">
									<ul class="imgUl">
										<li value="1"><img src="/image/defaultImgs/1.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="2"><img src="/image/defaultImgs/2.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="3"><img src="/image/defaultImgs/3.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="4"><img src="/image/defaultImgs/4.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="5"><img src="/image/defaultImgs/5.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="6"><img src="/image/defaultImgs/6.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="7"><img src="/image/defaultImgs/7.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="8"><img src="/image/defaultImgs/8.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="9"><img src="/image/defaultImgs/9.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="10"><img src="/image/defaultImgs/10.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="11"><img src="/image/defaultImgs/11.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="12"><img src="/image/defaultImgs/12.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="13"><img src="/image/defaultImgs/13.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="14"><img src="/image/defaultImgs/14.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="15"><img src="/image/defaultImgs/15.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="16"><img src="/image/defaultImgs/16.jpg" alt="" width="50" height="50"><b></b></li>
									</ul>
									<div class="btns mt20">
							...
							<div class="update-rcol">
								...
								<div class="smc">
									...
									<div class="img-m-cont img-cont">
										<div class="img-s">
									    <img id="midImage" width="100" height="100" name="midImage" src="/image/defaultImgs/1.jpg">
                                        </div>
									</div>
									100*100像素
									<div class="img-s-cont img-cont">
										<div class="img-s">
										<img id="smaImage" width="50" height="50" name="smaImage" src="/image/defaultImgs/1.jpg">
                                        </div>
									</div>
									50*50像素
								</div>
